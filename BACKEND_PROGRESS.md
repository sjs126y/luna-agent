...
- Architecture doc：新增 `docs/architecture.md`，系统说明 AppRuntime、ConversationService、create_agent_runtime、Gateway、provider/transport、工具权限、多模态、插件扩展、持久化和前端/桌面端接入边界；README 文档索引已挂入口。
