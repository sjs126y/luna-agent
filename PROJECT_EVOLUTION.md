...
| 范围 | 文件数 | 物理行数 |
| --- | ---: | ---: |
| `src/personal_agent/**/*.py` | 251 | 52,956 |
| `tests/**/*.py` | 98 | 30,157 |
| `plugins/**/*.py` | 8 | 1,923 |
| `scripts/**/*.py` | 2 | 287 |
| `examples/**/*.py` | 5 | 391 |
| 其他 Python 包装文件 | 1 | 0 |
| Python 合计 | 365 | 85,714 |
| Markdown 文档 | 42 | 7,303 |
| Git 已跟踪文件总数 | 458 | - |

项目规模更适合拆开理解：运行时与内置能力约 5.30 万行，测试约 3.02 万行，测试代码占 Python 总量约 35.2%。当前完整测试套件为 `1131 passed`。
