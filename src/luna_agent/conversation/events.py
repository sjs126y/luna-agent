...
EVENT_SCHEMAS: dict[str, EventSchema] = {
    ...
    "llm_start": EventSchema(
        ...
        fields=(
            ...
            EventFieldSpec("provider", "string", "Resolved provider name."),
            EventFieldSpec("model", "string", "Model name when known."),
            EventFieldSpec("api_mode", "string", "Resolved transport protocol mode."),
            EventFieldSpec("model_capability", "object", "Resolved model limits and their sources."),
