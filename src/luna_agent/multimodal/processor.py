...
from luna_agent.attachments.store import AttachmentStore, AttachmentStoreError, ResolvedAttachment
from luna_agent.attachments.text_extract import AttachmentTextExtractError, extract_attachment_text
...
def _notice_text(kind: str, label: str, reason: str) -> str:
    ...
    reason_label = {
        ...
        "ocr_response_invalid": "本地 OCR 响应格式无效。",
