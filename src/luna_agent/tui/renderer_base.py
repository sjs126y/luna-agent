...
from luna_agent.conversation.events import ConversationEvent, ConversationEventSink
...
class Renderer(ConversationEventSink):
    ...
    _DISPATCH = {
        ...
        "approval_review": "on_approval_review",
    ...
    async def on_approval_review(self, event: ConversationEvent) -> None: ...
