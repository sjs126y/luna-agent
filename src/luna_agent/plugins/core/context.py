...
if TYPE_CHECKING:
    ...
    from luna_agent.plugins.core.models import CommandEntry, LoadedPlugin
...
class PluginRuntimeContext:
    ...
    def _register_skills(self, relative_path: str | Path = "skills") -> int:
        ...
        from luna_agent.skills.registry import discover_skills
    ...
    def _register_hook(
        ...
        *,
        ...
        self._require_registration()
        from luna_agent.hooks import HookEvent
