...
from luna_agent.plugins.active.contracts import ActiveResourceRequest
...
class ActiveToolPort:
    ...
    async def call(
        ...
        *,
        ...
        from luna_agent.tools.execution_guard import tool_permission_category
    ...
    def _execution_context(
        ...
        *,
        ...
        from luna_agent.security.evaluator import isolated_security_context
