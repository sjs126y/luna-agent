...
_CURRENT_AGENT: ContextVar[Any | None] = ContextVar("luna_agent_current_tool_agent", default=None)
_CURRENT_CONFIRM: ContextVar[Any | None] = ContextVar("luna_agent_current_tool_confirm", default=None)
_CURRENT_EVENT_SINK: ContextVar[Any | None] = ContextVar("luna_agent_current_tool_event_sink", default=None)
