...
from luna_agent.agent.report import TurnReportRecorder
from luna_agent.context_budget import compose_context_text, estimate_context_budget
from luna_agent.conversation.events import ConversationEvent, emit_delta, emit_event
from luna_agent.llm.base import LLMRequestPlan
from luna_agent.tools.executor import deduplicate_tool_calls, execute_tool_calls
...
async def run_conversation(agent, ctx, *, event_sink=None, confirm=None, steer=None, session_key: str = "") -> dict:
    ...
    while agent._iteration_budget > 0:
        ...
        logging.getLogger("luna_agent.hooks").info(
            "LLM call: in=%d out=%d",
