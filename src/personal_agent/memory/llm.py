...
from personal_agent.memory.models import Observation
from personal_agent.memory.prompts import OBSERVATION_EXTRACTION_PROMPT, OBSERVATION_EXTRACTION_SYSTEM
