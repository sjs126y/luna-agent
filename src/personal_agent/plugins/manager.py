...
_BUILTIN_MANIFESTS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "version": "0.1.0",
        "description": "Built-in and data-directory skill discovery.",
        "kind": "builtin",
        "entrypoint": "personal_agent.plugins.builtin_skills:register",
        "provides": ["skills"],
        "enabled_by_default": True,
        "source": "builtin",
        "record_import_delta": False,
    },
    {
        ...
        "version": "0.1.0",
        "description": "Built-in multi-agent review workflow.",
        "kind": "workflow",
        "entrypoint": "personal_agent.plugins.builtin_workflows:register",
        "provides": ["workflows"],
        "enabled_by_default": True,
        "source": "builtin",
        "record_import_delta": False,
    ...
    {
        "key": "builtin/llm",
        "name": "Built-in LLM Providers",
        "version": "0.1.0",
        "description": "Provider and transport registrations.",
        "kind": "builtin",
        "entrypoint": "personal_agent.plugins.builtin_llm:register",
        "provides": ["llm"],
        "enabled_by_default": True,
        "source": "builtin",
        "record_import_delta": False,
    },
    {
        ...
        "version": "0.1.0",
        "description": "Feishu adapter registration.",
        "kind": "platform",
        "entrypoint": "personal_agent.plugins.platform_feishu:register",
    ...
    },
    {
        ...
        "version": "0.1.0",
        "description": "Telegram adapter registration.",
        "kind": "platform",
        "entrypoint": "personal_agent.plugins.platform_telegram:register",
    ...
    },
    {
        ...
        "version": "0.1.0",
        "description": "WeChat adapter registration.",
        "kind": "platform",
        "entrypoint": "personal_agent.plugins.platform_wechat:register",
        "requires_env": ["WEIXIN_TOKEN"],
        "provides": ["platforms"],
        "enabled_by_default": True,
        "source": "builtin",
        "deferred": True,
